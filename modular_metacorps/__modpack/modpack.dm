/datum/modpack
	...
	var/icon = 'modular_metacorps/__modpack/mods_icon_placeholder.dmi'
...
/datum/modpack/ui_assets(mob/user)
	return list(
		get_asset_datum(/datum/asset/spritesheet/modpacks),
	)
...
/datum/modpack/ui_static_data(mob/user)
	...
	var/datum/asset/spritesheet/assets = get_asset_datum(/datum/asset/spritesheet/modpacks)
