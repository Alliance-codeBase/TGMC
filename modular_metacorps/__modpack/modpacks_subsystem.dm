#define FIRE_PRIORITY_MODPACKS 84

// Subsystem of modpacks
SUBSYSTEM_DEF(modpacks)
	name = "Modpacks"
	priority = FIRE_PRIORITY_MODPACKS
	flags = SS_NO_FIRE
...
//Icons at icons/UI_Icons/lobby_button.dmi, don't move it anywhere
/atom/movable/screen/text/lobby/clickable/modpacks
	maptext = "<span class='lobbytext'>MODIFICATIONS</span>"
	icon_state = "modpacks"

/atom/movable/screen/text/lobby/clickable/modpacks/Click(location, control, params)
	. = ..()
